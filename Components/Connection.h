...
class Connection :	public Component
{
	...
	int	numOfInputPin;		//The Input pin to which this connection is linked
...
public:
	...
	Connection(const GraphicsInfo &r_GfxInfo, OutputPin *pSrcPin,InputPin *pDstPin , int num);
	...
	virtual void save(ofstream &f , Component *C);
	virtual void load();
};
/*
*	As3decimal
